...
void create_screen_main() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_main_main, LV_EVENT_ALL, flowState);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_actual_mould_settings_table(obj, getFlowState(flowState, 4), 21);
        }
    }
...
void tick_screen_main() {
    ...
    tick_user_widget_actual_mould_settings_table(getFlowState(flowState, 4), 21);
}
...
void create_screen_mould_settings() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_mould_settings_mould_settings, LV_EVENT_ALL, flowState);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_plunger_and_tip(obj, getFlowState(flowState, 0), 38);
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.obj4 = obj;
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_slider_encoder(obj, getFlowState(flowState, 2), 45);
        }
    }
...
void tick_screen_mould_settings() {
    void *flowState = getFlowState(0, 1);
    (void)flowState;
    tick_user_widget_plunger_and_tip(getFlowState(flowState, 0), 38);
    tick_user_widget_slider_encoder(getFlowState(flowState, 2), 45);
}
...
static const char *object_names[] = { "main", "mould_settings", "common_settings", "plunger_tip", "plunger_tip__background_barrel", "plunger_tip__background_barrel_interior", "plunger_tip__plunger", "plunger_tip__plunger_tip", "plunger_tip__refill_hole", "plunger_tip__obj0", "obj0", "obj0__background_barrel", "obj0__background_barrel_interior", "obj0__plunger", "obj0__plunger_tip", "obj0__refill_hole", "obj0__obj0", "obj1", "obj1__test_plunger_slider", "obj1__machine_state_text", "obj2", "obj2__title_mould_settings_page", "obj2__actual_mould_settings_table_view", "obj2__mould_name_label", "obj2__mould_fill_speed", "obj2__mould_fill_dist", "obj2__mould_fill_accel", "obj2__mould_hold_speed", "obj2__mould_hold_dist", "obj2__mould_hold_accel", "obj2__mould_name_value", "obj2__mould_fill_speed_value", "obj2__mould_fill_dist_value", "obj2__mould_fill_accel_value", "obj2__mould_hold_speed_value", "obj2__mould_hold_dist_value", "obj2__mould_hold_accel_value", "obj3", "obj3__background_barrel", "obj3__background_barrel_interior", "obj3__plunger", "obj3__plunger_tip", "obj3__refill_hole", "obj3__obj0", "obj4", "obj4__test_plunger_slider", "obj4__machine_state_text", "obj5", "obj5__background_barrel", "obj5__background_barrel_interior", "obj5__plunger", "obj5__plunger_tip", "obj5__refill_hole", "obj5__obj0", "obj6", "obj6__test_plunger_slider", "obj6__machine_state_text" };
