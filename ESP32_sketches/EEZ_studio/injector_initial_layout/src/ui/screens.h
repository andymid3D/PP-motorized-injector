...
typedef struct _objects_t {
    ...
    lv_obj_t *obj2;
    lv_obj_t *obj2__title_mould_settings_page;
    lv_obj_t *obj2__actual_mould_settings_table_view;
    lv_obj_t *obj2__mould_name_label;
    lv_obj_t *obj2__mould_fill_speed;
    lv_obj_t *obj2__mould_fill_dist;
    lv_obj_t *obj2__mould_fill_accel;
    lv_obj_t *obj2__mould_hold_speed;
    lv_obj_t *obj2__mould_hold_dist;
    lv_obj_t *obj2__mould_hold_accel;
    lv_obj_t *obj2__mould_name_value;
    lv_obj_t *obj2__mould_fill_speed_value;
    lv_obj_t *obj2__mould_fill_dist_value;
    lv_obj_t *obj2__mould_fill_accel_value;
    lv_obj_t *obj2__mould_hold_speed_value;
    lv_obj_t *obj2__mould_hold_dist_value;
    lv_obj_t *obj2__mould_hold_accel_value;
    lv_obj_t *obj3;
    lv_obj_t *obj3__background_barrel;
    lv_obj_t *obj3__background_barrel_interior;
    lv_obj_t *obj3__plunger;
    lv_obj_t *obj3__plunger_tip;
    lv_obj_t *obj3__refill_hole;
    lv_obj_t *obj3__obj0;
    lv_obj_t *obj4;
    lv_obj_t *obj4__test_plunger_slider;
    lv_obj_t *obj4__machine_state_text;
    lv_obj_t *obj5;
